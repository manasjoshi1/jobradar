 ...
 *  - Correct password logs in and shows the user name in header
 *  - Logout returns to /login
 */
import { test, expect } from "@playwright/test";
import { E2E_PASSWORD, E2E_USER_NAME } from "./helpers";
...
test("empty password keeps submit disabled", async ({ page }) => {
  ...
  // Button should be disabled while password field is empty
